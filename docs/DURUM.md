...
- **Senkoplu notaları halkayla işaretlemek** (v115'te denendi, v116'da geri
  alındı). Oyuncu: *"beğenmedim, geri al."* Kod tamamen kalktı; aşağıdaki
  ölçüm durmalı, çünkü asıl değerli olan o.
- **Entertainer'a birleştirme (koşu) getirmek için eşiği oynatmak.**
  Ölçüldü ve olmuyor:

  - Entertainer **hızlı değil**. En hızlı aralığı 0.208 s, ki Für Elise'in
    *sıradan* akan notalarıyla birebir aynı (biri 72 bpm'de onaltılık,
    diğeri 144'te sekizlik). Saniyeye bakan hiçbir eşik ikisini ayıramaz.
  - Eşik 0.209 olursa: Entertainer 0 → 105 koşu, **ama** Für Elise 3 → 140,
    Halvorsen 0 → 73. Kütüphanenin büyük kısmı kaydırmaya döner.
  - Eşik 0.18 veya 0.192 olursa: Entertainer'a **hiç** dokunmaz (parçada
    0.191'lik *tek* bir aralık var, gerisi 0.208), buna karşılık
    Passacaglia'nın kolay düzenlemesini 98 notalık tek bir koşuya çevirir.
  - Arada bir yer yok: parçanın aralık dağılımı 0.191 × **1**, 0.208 × 561,
    0.417 × 720. Kapı ya kapalı ya tamamen açık.

  **Entertainer'ı zorlaştıran şey aralık değil yoğunluk:** 1372 dokunuş
  (kütüphanenin en fazlası) ve **133 saniye** boyunca yarım saniyelik bir
  nefes bile yok. Bu sorunun aracı birleştirme değil.

  Yan bulgu (durursa işe yarar): senkop ölçüsü ragtime'ı kütüphanede tek
  başına ayırıyor — nota vuruşun arasında başlayıp bir sonraki vuruşun
  üstünden geçiyorsa ve o vuruşta o seste bir şey çalınmıyorsa. Entertainer
  77 (%6), Passacaglia 22, Kanon 7, diğer hepsi 0. Ayırt edici üç şey:
  **el el** bakılacak (müziğin tamamına bakınca ragtime 8'e düşüyor, çünkü
  nabzı sol el tutuyor), ve nota **bir vuruştan kısa** olacak (yoksa Prelüd'ün
  1.75 vuruşluk basları 66 kez senkop sayılıyor). Ölçü doğru; **gösterimi**
  beğenilmedi.
